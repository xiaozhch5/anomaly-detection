...
class Train:
    ...
    def create_dataset(self, data_set, look_back):
    ...
    look_back = 1
    trainX, trainY = create_dataset(self, train_list, look_back)
    testX, testY = create_dataset(self, test_list, look_back)
    ...
    model.save(os.path.join("../model", "model_1" + ".h5"))
    # make predictions
